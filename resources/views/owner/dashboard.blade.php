                                ...
                                <div class="col-xl-3 col-md-4 col-sm-6 mb-4">
                                    <div class="card orange-card h-100">
                                        <div class="card-body text-center">
                                            @if($vehicle->kendaraan->gambar)
                                                <img src="{{ asset('storage/' . $vehicle->kendaraan->gambar) }}" 
                                                     alt="{{ $vehicle->kendaraan->nama_mobil }}" 
                                            ...
                                            <h6 class="fw-bold text-white mb-1">{{ $vehicle->kendaraan->nama_mobil ?? 'N/A' }}</h6>
                                            <small class="text-muted d-block mb-2">{{ $vehicle->kendaraan->merk ?? 'N/A' }}</small>
                                            
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <small class="text-muted">Kategori:</small>
                                                <small class="text-white">{{ $vehicle->kendaraan->kategori->nama_kategori ?? '-' }}</small>
                                            </div>
                                            
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                <small class="text-muted">Stok:</small>
                                                <span class="badge bg-info">{{ $vehicle->kendaraan->stok ?? 0 }}</span>
                                            </div>

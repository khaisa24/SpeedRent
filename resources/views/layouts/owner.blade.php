        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-menu">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('owner.kategori') }}" class="nav-link {{ request()->routeIs('owner.kategori*') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('owner.kendaraan') }}" class="nav-link {{ request()->routeIs('owner.kendaraan*') ? 'active' : '' }}">
                    ...
                    {{-- <li class="nav-item">
                        <a href="{{ route('owner.rental') }}" class="nav-link {{ request()->routeIs('owner.rental*') ? 'active' : '' }}">
                    ...
                    {{-- <li class="nav-item">
                        <a href="{{ route('owner.pembayaran') }}" class="nav-link {{ request()->routeIs('owner.pembayaran*') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('owner.laporan') }}" class="nav-link {{ request()->routeIs('owner.laporan*') ? 'active' : '' }}">
            ...
            <nav class="top-navbar">
                <div class="container">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <!-- Page Title -->
                        <h5 class="mb-0 text-white">@yield('title', 'Dashboard Owner')</h5>

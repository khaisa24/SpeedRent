                        ...
                        <form action="<?php echo e(isset($editKategori) ? route('admin.kategori.update', $editKategori->id_kategori) : route('admin.kategori.store')); ?>" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nama_kategori" name="nama_kategori" 
                                       value="<?php echo e(old('nama_kategori', $editKategori->nama_kategori ?? '')); ?>" 
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-control" id="jenis" name="jenis" required>
                                    ...
                                    <option value="Mobil" <?php echo e(old('jenis', $editKategori->jenis ?? '') == 'Mobil' ? 'selected' : ''); ?>>Mobil</option>
                                    <option value="Motor" <?php echo e(old('jenis', $editKategori->jenis ?? '') == 'Motor' ? 'selected' : ''); ?>>Motor</option>
                                    <option value="Lainnya" <?php echo e(old('jenis', $editKategori->jenis ?? '') == 'Lainnya' ? 'selected' : ''); ?>>Lainnya</option>
                                </select>
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td class="text-white"><?php echo e($kategori->nama_kategori); ?></td>
                                                <td>
                                                    <span class="badge 
